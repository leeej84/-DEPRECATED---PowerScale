...
$delayShutdown = $null                                                                      #Delay shutdowns when using forced logoff by n minutes - leave as $null to have no delay
...
$configContent = [PSCustomObject]@{
    ...
    delayShutdownComment = "Delay shutdowns by this script for n minutes"
