...
$maintenanceReleaseTime = "05:15"                                                           #Time in hours and minutes that servers will be taken out of maintenance mode before business hours if not forcing logoffs
...
$configContent = [PSCustomObject]@{
    ...
    maintenanceReleaseTimeComment = "Hours before the business start time that machines will be taken out of maintenance mode"
    maintenanceReleaseTime = $maintenanceReleaseTime
