...
$additionalScaleDown = $false                                                               #When scaling down all machines will be shutdown to match your target scaling figure, this setting allows you to restrict the number of machines shutdown to avoid a large drop of machines being powered down
$additionalScaleDownFactor = 5                                                              #Select the number of machines that should be scaled down at each shutdown window.
...
$configContent = [PSCustomObject]@{
    ...
    additionalScaleDown = $additionalScaleDown
    additionalScaleDownComment = "When scaling down all machines will be shutdown to match your target scaling figure, this setting allows you to restrict the number of machines shutdown to avoid a large drop of machines being powered down"
    additionalScaleDownFactor = $additionalScaleDownFactor
    additionalScaleDownFactorComment = "Select the number of machines that should be scaled down at each shutdown window"
